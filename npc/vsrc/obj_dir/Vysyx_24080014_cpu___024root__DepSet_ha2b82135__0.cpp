...
VL_INLINE_OPT void Vysyx_24080014_cpu___024root___nba_sequent__TOP__0(Vysyx_24080014_cpu___024root* vlSelf) {
    ...
    __Vdly__ysyx_24080014_cpu__DOT__pc = 0;
    // Body
    __Vdly__ysyx_24080014_cpu__DOT__pc = vlSelf->ysyx_24080014_cpu__DOT__pc;
    if (vlSelf->rst) {
        __Vdly__ysyx_24080014_cpu__DOT__pc = 0x80000000U;
        vlSelf->ysyx_24080014_cpu__DOT__next_pc = ((IData)(4U) 
                                                   + vlSelf->ysyx_24080014_cpu__DOT__pc);
    } else {
        __Vdly__ysyx_24080014_cpu__DOT__pc = vlSelf->ysyx_24080014_cpu__DOT__next_pc;
        vlSelf->ysyx_24080014_cpu__DOT__next_pc = ((IData)(4U) 
                                                   + vlSelf->ysyx_24080014_cpu__DOT__pc);
    }
    vlSelf->ysyx_24080014_cpu__DOT__pc = __Vdly__ysyx_24080014_cpu__DOT__pc;
}
...
#endif
                    VL_FATAL_MT("ysyx_24080014_cpu.v", 1, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("ysyx_24080014_cpu.v", 1, "", "NBA region did not converge.");
            }
